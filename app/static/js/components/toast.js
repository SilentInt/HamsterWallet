    ...
    const toast = DOM.create("div", {
      ...
      innerHTML: `
        <div style="display: flex; align-items: center; padding: 12px 16px;">
          <i class="${icons[type]} me-2" style="color: ${
        colors[type]
      }; font-size: 1.2rem;"></i>
          <span style="font-weight: 500; flex: 1;">${message}</span>
          ${
            options.closable !== false
              ? '<button class="toast-close" style="background: none; border: none; color: var(--ios-gray-5); font-size: 1.2rem; cursor: pointer; margin-left: 12px;">&times;</button>'
              : ""
          }
        </div>
      `,
